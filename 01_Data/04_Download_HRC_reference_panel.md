...
We will be imputing our tutorial genotype data using this reference panel so we need to download the HRC reference panel in order to do some pre-imputation checks first
